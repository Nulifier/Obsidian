"use strict";var _interopRequireDefault = require("babel-runtime/helpers/interop-require-default")["default"];Object.defineProperty(exports, "__esModule", { value: true });var _lodash = require("lodash");var _lodash2 = _interopRequireDefault(_lodash);
...
{ 
	...
	options: function options(opts) {
		...
		if (_lodash2["default"].isPlainObject(opts)) {
			_lodash2["default"].forOwn(opts, function (value, key) {
				this.set(key, value);}, 
			this);}
